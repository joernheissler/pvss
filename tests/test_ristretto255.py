...
from pvss.ristretto_255 import create_ristretto_255_parameters, Ristretto255Parameters, Ristretto255ScalarGroup, Ristretto255Group, Ristretto255Point
from pvss.pvss import Pvss
from pvss.asn1 import PreGroupValue, ImgGroupValue
...
def test_group() -> None:
    ...
    assert bytes(grp.from_hash(sha512(b'Ristretto is traditionally a short shot of espresso coffee').digest())) == bytes.fromhex('3066f82a1a747d45120d1740f14358531a8f04bbffe6a819f86dfe50f44a0a46')
